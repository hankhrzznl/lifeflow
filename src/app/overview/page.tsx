...
function CenterCard({
  ...
  return (
    <motion.button
      ...
      className={`group relative overflow-hidden rounded-2xl bg-gradient-to-br ${center.from} ${center.via} ${center.to} p-4 text-left text-white shadow-lg shadow-slate-200/60 flex flex-col w-[576px] h-[420px]`}
    >
      {/* 微弱右上光晕 */}
